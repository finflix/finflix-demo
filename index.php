...
<body>
    ...
    <section id="home" class="iq-main-slider p-0">
        <div id="home-slider" class="slider m-0 p-0">
            ...
            ?>
                    <div class="slide slick-bg s-bg-<?= $i ?>" style="width: 1903px;background: url(<?= $thumbnail ?>);background-repeat: no-repeat;background-position: center;background-size: cover;">
                            ...
                            <div class="slider-inner h-100">
                                <div class="row align-items-center  h-100">
                                    <div class="col-xl-6 col-lg-12 col-md-12">
                                        ...
                                        <h1 class="slider-text big-title title text-uppercase" data-animation-in="fadeInLeft" data-delay-in="0.6"><?= $chapter_name ?></h1>
                                        ...
                                        <div class="d-flex align-items-center r-mb-23" data-animation-in="fadeInUp" data-delay-in="1.2">
                                            <a href="videoPlayer.php?course=<?= $video_uuid ?>&module=<?= $module_id ?>" class="btn btn-hover"><i class="fa fa-play mr-2" aria-hidden="true"></i>Play
                                                Now</a>
                                ...
                                <div class="trailor-video">
                                    <a href="videoPlayer.php?course=<?= $video_uuid ?>&module=<?= $module_id ?>" class="video-open playbtn">
    ...
    <div class="main-content">
                                                ...
                                                <a href="videoPlayer.php?course=<?= $video_uuid ?>&module=<?= $module_id ?>">
                                                    <div class="block-images position-relative">
                                                        ...
                                                        <div class="block-description">
                                                            ...
                                                            <div class="hover-buttons">
                                                                <a href="videoPlayer.php?course=<?= $video_uuid ?>&module=<?= $module_id ?>" class="btn btn-hover"><i class="fa fa-play mr-1" aria-hidden="true"></i>
                                                                    Play Now</a>
                                                            </div>
                                                        </div>
                                                        <div class="block-social-info">
                                                            <ul class="list-inline p-0 m-0 music-play-lists">
                                                                ...
                                                                <li onclick="removeVid('<?php echo $user_address ?>','<?php echo $video_uuid ?>')">
        ...
        <?php
        $query = "SELECT * FROM `video_info` WHERE `module`= 'Explainers' LIMIT 10";
        $result = mysqli_query($con, $query);
        if (mysqli_num_rows($result) > 0) {
            $i = 1;
        ?>
            <section id="iq-suggestede" class="s-margin">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-12 overflow-hidden">
                            <div class="iq-main-header d-flex align-items-center justify-content-between">
                                <h4 class="main-title"><a href="#">Explainers Videos</a></h4>
                            </div>
                            <div class="suggestede-contens">
                                <ul class="list-inline favorites-slider row p-0 mb-0 favorites-slider-new">
                                    <?php
        ...
        <?php } ?>
        <?php
        $query = "SELECT * FROM `video_info` WHERE `module`= 'Tutorials' LIMIT 10";
        $result = mysqli_query($con, $query);
        if (mysqli_num_rows($result) > 0) {
            $i = 1;
        ?>
            <section id="iq-suggestede" class="s-margin">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-12 overflow-hidden">
                            <div class="iq-main-header d-flex align-items-center justify-content-between">
                                <h4 class="main-title"><a href="#">Tutorials Videos</a></h4>
                            </div>
                            <div class="suggestede-contens">
                                <ul class="list-inline favorites-slider row p-0 mb-0 favorites-slider-new">
                                    <?php
        ...
        <?php
        $query = "SELECT * FROM `video_info` WHERE `module`= 'Review' LIMIT 10";
        $result = mysqli_query($con, $query);
        if (mysqli_num_rows($result) > 0) {
            $i = 1;
        ?>
            <section id="iq-suggestede" class="s-margin">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-12 overflow-hidden">
                            <div class="iq-main-header d-flex align-items-center justify-content-between">
                                <h4 class="main-title"><a href="#">Review Videos</a></h4>
                            </div>
                            <div class="suggestede-contens">
                                <ul class="list-inline favorites-slider row p-0 mb-0 favorites-slider-new">
                                    <?php
        ...
        <?php } ?>
        <?php
        $query = "SELECT * FROM `video_info` WHERE `module`= 'News' LIMIT 10";
        $result = mysqli_query($con, $query);
        if (mysqli_num_rows($result) > 0) {
            $i = 1;
        ?>
            <section id="iq-suggestede" class="s-margin">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-12 overflow-hidden">
                            <div class="iq-main-header d-flex align-items-center justify-content-between">
                                <h4 class="main-title"><a href="#">News Videos</a></h4>
                            </div>
                            <div class="suggestede-contens">
                                <ul class="list-inline favorites-slider row p-0 mb-0 favorites-slider-new">
                                    <?php
        ...
        <?php } ?>
        <?php
        $query = "SELECT * FROM `video_info` WHERE `module`= 'Others' LIMIT 10";
        $result = mysqli_query($con, $query);
        if (mysqli_num_rows($result) > 0) {
            $i = 1;
        ?>
            <section id="iq-suggestede" class="s-margin">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-12 overflow-hidden">
                            <div class="iq-main-header d-flex align-items-center justify-content-between">
                                <h4 class="main-title"><a href="#">Others Videos</a></h4>
                            </div>
                            <div class="suggestede-contens">
                                <ul class="list-inline favorites-slider row p-0 mb-0 favorites-slider-new">
                                    <?php
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                $module_id = $row['module_uuid'];
        ?>
                <section id="parallex" class="parallax-window" style="background: url('<?= $thumbnail ?>');background-size: cover;background-attachment:fixed;">
                            ...
                            <div class="col-lg-4 r-mb-23">
                                <div class="text-left">
                                    ...
                                    <div class="parallax-buttons">
                                        <a href="videoPlayer.php?course=<?= $video_uuid ?>&module=<?= $module_id ?>" class="btn btn-hover">Play Now</a>
                                        <a href="./courses" class="btn btn-link">More details</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-sm-12 overflow-hidden">
                        ...
                        <ul id="trending-slider" class="list-inline p-0 m-0  d-flex align-items-center">
                            ...
                            ?>
                                    <li>
                                        <div class="tranding-block position-relative" style="background-image: url(<?= $thumbnail ?>);">
                                            <div class="trending-custom-tab">
                                                <div class="tab-title-info position-relative">
                                                    <ul class="trending-pills d-flex nav nav-pills justify-content-center align-items-center text-center" role="tablist">
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link" data-toggle="pill" href="#trending-data2" role="tab" aria-selected="false">Videos</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" data-toggle="pill" href="#trending-data3" role="tab" aria-selected="false">Similar Like This</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                    ...
                                                    <div id="trending-data1" class="overview-tab tab-pane fade active show">
                                                        <div class="trending-info align-items-center w-100 animated fadeInUp">
                                                            ...
                                                            <div class="d-flex align-items-center series mb-4">
                                                                <a href="javascript:void(0);"><img src='<?= $thumbnail ?>' class="img-fluid" alt="" style="width:72px;height:72px;object-fit: contain;"></a>
                                                            ...
                                                            <div class="p-btns">
                                                                <div class="d-flex align-items-center p-0">
                                                                    <a href="videoPlayer.php?course=<?= $video_uuid ?>&module=<?= $module_id ?>" class="btn btn-hover mr-2" tabindex="0"><i class="fa fa-play mr-2" aria-hidden="true"></i>Play
                                                                        Now</a>
                                                                    <a href="./userVideosList" class="btn btn-link" tabindex="0">
                                                                        <i class="ri-information-fill"></i>My
                                                                        List</a>
                                                                </div>
                                                            </div>
                                                            <div class="trending-list mt-4">
                                                                <div class="text-primary title text-color">This Is: <span class="text-body">Cryto,Blockchain</span>
                                                                </div>
                                                                <div class="text-primary title text-color">Added On: <span class="text-body"><?= $date ?></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <div class="owl-carousel owl-theme episodes-slider1 list-inline p-0 mb-0">
                                                                    ...
                                                                    if (mysqli_num_rows($result2) > 0) {
                                                                        ...
                                                                        while ($row2 = mysqli_fetch_assoc($result2)) {
                                                                            $thumbnail2 = $row2['thumbnail_ipfs'];
                                                                            ...
                                                                            <div class="e-item">
                                                                                <div class="block-image position-relative">
                                                                                    <a href="videoPlayer.php?course=<?= $video_id2 ?>&module=<?= $module_name2 ?>">
                                                                                        <img src='<?= $thumbnail2 ?>' class="img-fluid" alt="">
                                                                                    </a>
                                                                                    <div class="episode-number"><?= $i ?></div>
                                                                                    <div class="episode-play-info">
                                                                                        <div class="episode-play">
                                                                                            <a href="videoPlayer.php?course=<?= $video_id2 ?>&module=<?= $module_name2 ?>" tabindex="0"><i class="ri-play-fill"></i></a>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="episodes-description text-body mt-2">
                                                                                    <div class="d-flex align-items-center justify-content-between">
                                                                                        <a href="videoPlayer.php?course=<?= $video_id2 ?>&module=<?= $module_name2 ?>">Episode
                                                                                            <?= $i ?></a>
                                                                ...
                                                                <div class="owl-carousel owl-theme episodes-slider1 list-inline p-0 mb-0">
                                                                    ...
                                                                    if (mysqli_num_rows($result3) > 0) {
                                                                        ...
                                                                        while ($row3 = mysqli_fetch_assoc($result3)) {
                                                                            $thumbnail3 = $row3['thumbnail_ipfs'];
                                                                    ...
                                                                    ?>
                                                                            <div class="e-item">
                                                                                <div class="block-image position-relative">
                                                                                    <a href="videoPlayer.php?course=<?= $video_id3 ?>&module=<?= $module_id3 ?>">
                                                                                        <img src="<?= $thumbnail3 ?>" class="img-fluid" alt="">
                                                                                    </a>
                                                                                    <div class="episode-number"><?= $i ?></div>
                                                                                    <div class="episode-play-info">
                                                                                        <div class="episode-play">
                                                                                            <a href="videoPlayer.php?course=<?= $video_id3 ?>&module=<?= $module_id3 ?>" tabindex="<?= $i - 1 ?>"><i class="ri-play-fill"></i></a>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="episodes-description text-body mt-2">
                                                                                    <div class="d-flex align-items-center justify-content-between">
                                                                                        <a href="videoPlayer.php?course=<?= $video_id3 ?>&module=<?= $module_id3 ?>">Episode
                                                                                            <?= $i ?></a>
                                                                                        <span class="text-primary">2.25 m</span>
                                                                                    </div>
                                        ...
                                        <div class="tranding-block position-relative" style="background-image: url(<?= $thumbnail ?>);">
                                            <div class="trending-custom-tab">
                                                <div class="tab-title-info position-relative">
                                                    <ul class="trending-pills d-flex nav nav-pills justify-content-center align-items-center text-center" role="tablist">
                                                        <li class="nav-item">
                                                            <a class="nav-link active show" data-toggle="pill" href="#trending-data4" role="tab" aria-selected="true">Overview</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" data-toggle="pill" href="#trending-data5" role="tab" aria-selected="false">Videos</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" data-toggle="pill" href="#trending-data6" role="tab" aria-selected="false">Similar Like This</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="trending-content">
                                        ...
                                        <div class="tranding-block position-relative" style="background-image: url(<?= $thumbnail ?>);">
                                            <div class="trending-custom-tab">
                                                <div class="tab-title-info position-relative">
                                                    <ul class="trending-pills d-flex nav nav-pills justify-content-center align-items-center text-center" role="tablist">
                                                        <li class="nav-item">
                                                            <a class="nav-link active show" data-toggle="pill" href="#trending-data7" role="tab" aria-selected="true">Overview</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" data-toggle="pill" href="#trending-data8" role="tab" aria-selected="false">Videos</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" data-toggle="pill" href="#trending-data9" role="tab" aria-selected="false">Similar Like This</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="trending-content">
                                        ...
                                        <div class="tranding-block position-relative" style="background-image: url(<?= $thumbnail ?>);">
                                            <div class="trending-custom-tab">
                                                <div class="tab-title-info position-relative">
                                                    <ul class="trending-pills d-flex nav nav-pills justify-content-center align-items-center text-center" role="tablist">
                                                        <li class="nav-item">
                                                            <a class="nav-link active show" data-toggle="pill" href="#trending-data10" role="tab" aria-selected="true">Overview</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" data-toggle="pill" href="#trending-data11" role="tab" aria-selected="false">Videos</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" data-toggle="pill" href="#trending-data12" role="tab" aria-selected="false">Similar Like This</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="trending-content">
                                            ...
                                            <div class="trending-custom-tab">
                                                <div class="tab-title-info position-relative">
                                                    <ul class="trending-pills d-flex nav nav-pills justify-content-center align-items-center text-center" role="tablist">
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link" data-toggle="pill" href="#trending-data14" role="tab" aria-selected="false">Videos</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" data-toggle="pill" href="#trending-data15" role="tab" aria-selected="false">Similar Like This</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="trending-content">
                                        ...
                                        <div class="tranding-block position-relative" style="background-image: url(<?= $thumbnail ?>);">
                                            <div class="trending-custom-tab">
                                                <div class="tab-title-info position-relative">
                                                    <ul class="trending-pills d-flex nav nav-pills justify-content-center align-items-center text-center" role="tablist">
                                                        <li class="nav-item">
                                                            <a class="nav-link active show" data-toggle="pill" href="#trending-data16" role="tab" aria-selected="true">Overview</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" data-toggle="pill" href="#trending-data17" role="tab" aria-selected="false">Videos</a>
                                                        </li>
                                                        <li class="nav-item">
                                                            <a class="nav-link" data-toggle="pill" href="#trending-data18" role="tab" aria-selected="false">Similar Like This</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <div class="trending-content">
    ...
    <?php
    $query = "SELECT * FROM `video_info` WHERE `module`='Tutorials' ORDER BY RAND() LIMIT 10";
    $result = mysqli_query($con, $query);
    if (mysqli_num_rows($result) > 0) {
        $i = 1;
    ?>
        <section id="iq-suggestede" class="s-margin">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12 overflow-hidden">
                        <div class="iq-main-header d-flex align-items-center justify-content-between">
                            <h4 class="main-title"><a href="#">News</a></h4>
                        </div>
                        <div class="suggestede-contens">
                            <ul class="list-inline favorites-slider row p-0 mb-0 favorites-slider-new">
                                <?php
