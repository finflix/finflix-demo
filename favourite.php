...
if(!isset($_GET['user'])){
    ...
    if(isset($_GET['user']) && isset($_SESSION['userAddress']) && ($_SESSION['userAddress'] === $_GET['user'])){
        $user_address = $_GET['user'];
    }else{
        header('Location:index');
    }
?>
                ...
                <div class="row">
                    <div class="col-sm-12 overflow-hidden">
                        <h4 class="slider-text big-title title text-uppercase fadeInLeft animated text-center"
                            style="font-size:30px;">Your Favourite Videos</h4>
                    </div>
                </div>
            </div>
        </section>
                                        ...
                                        <div class="episodes-description text-body mt-2">
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <span class="text-primary" style="cursor: pointer"
                                                    onclick="removeVid('<?php echo $user_address ?>','<?php echo $video_uuid ?>')">Remove</span>
                                            </div>
