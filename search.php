            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12 overflow-hidden">
                        <h4 class="slider-text big-title title text-uppercase fadeInLeft animated text-center" style="font-size:30px;">Search Result for <span class="text-danger" style="-webkit-text-fill-color: #5f8be9;text-transform:none;"><?= $query ?></span></h4>
                    </div>
                </div>
            </div>
        </section>
