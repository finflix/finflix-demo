            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12 overflow-hidden">
                        <h4 class="slider-text big-title title text-uppercase fadeInLeft animated text-center"
                            style="font-size:30px;">Search Result for <span class="text-danger"
                                style="-webkit-text-fill-color: #5f8be9;text-transform:none;"><?= $query ?></span></h4>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="col-sm-12 overflow-hidden">
                        ...
                        <div>
                            <div class="list-inline row p-0 mb-0">
                                <?php
                           $query = "SELECT * FROM `video_info` WHERE `name` like '%$query%' OR `video_id` like '%$query%' OR `video_uid` like '%$query%' OR `module` like '%$query%' OR `video_desc` like '%$query%'";
                                ...
                                <div class="my-4 mx-3" style="width: 438.75px;">
                                    <div class="e-item">
                                        <div class="block-image position-relative">
                                            <a href="videoPlayer.php?course=<?= $video_id ?>&amp;module=Cryptonite"
                                                tabindex="0">
                                            ...
                                            <div class="episode-play-info">
                                                <div class="episode-play">
                                                    <a href="videoPlayer.php?course=<?= $video_id ?>&amp;module=Cryptonite"
                                                        tabindex="<?= $chapter_part?>"><i class="ri-play-fill"></i></a>
                                                </div>
                                            </div>
                                        </div>
                           ...
                           $i=$i+1;
                                ...
                                <div class="my-4 mx-3 text-center w-100">
                                    <h1>No Data Found</h1>
                                    <p class="text-center">Try to search again with proper keyword like name,video-id
                                        etc..</p>
                                </div>
                                <?php } ?>
                            </div>
